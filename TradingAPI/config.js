...
export const PRICE_HISTORY_LOOKBACK = 10;

// The "personalities" of your stocks
export const SIMULATION_CONFIG = {
  'AAPL': {
    basePrice: 270.37, // Hardcoded real closing price
    trend: 0.005, // A slight upward drift per minute
    waves: [
      { amplitude: 1.5, frequency: 0.05 }, // A long, slow wave
      { amplitude: 0.3, frequency: 0.3 },  // A medium wave
      { amplitude: 0.1, frequency: 0.9 }   // Fast "noise"
    ]
  },
  'MSFT': {
    basePrice: 517.81,
    trend: 0.008, // A slightly stronger trend
    waves: [
  ...
  'GOOGL': {
    basePrice: 281.82,
    trend: 0.006, // Moderate upward trend
    waves: [
  ...
  'NVDA': {
    basePrice: 202.49,
    trend: 0.012, // Higher volatility/trend
    waves: [
